...
- 2026-07-06 [세션] 주차 판정을 "겹침"에서 "완전 포함"으로 강화.
	...
	- 테스트 4개 추가(포함/모서리 이탈/완전 밖/45도 회전 시 대각선 폭 초과로 비포함) — 38/38 통과.
	- [참고] 현재 주차존 3.0×3.0, 비행기 풋프린트 약 2.71×2.74라 여유가 0.15~0.3 정도로 빠듯함. 각 잡고 들어와야 성공하므로 의도적으로 어렵게 느껴질 수 있음 — 필요하면 주차존 크기 조정 고려.
